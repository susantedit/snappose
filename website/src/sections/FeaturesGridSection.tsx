...
const FULL_FEATURE_SET = [
  ...
  { id: 2, title: 'Dual Ghost & Skia Overlay', category: 'camera', desc: 'Toggle between translucent ghost silhouettes and Skia vector wireframes.', icon: Layers, status: 'Production v1.0', color: '#00D9FF' },
  { id: 3, title: 'Pose Match Score (0–100%)', category: 'camera', desc: '60 FPS real-time calculation comparing 33 joint angles with color feedback.', icon: Activity, status: 'Production v1.0', color: '#B7FF00' },
  ...
  { id: 5, title: 'AR Skeleton Wireframe', category: 'camera', desc: 'Glowing vector bone connections with dynamic green/orange lock cues.', icon: Focus, status: 'Production v1.0', color: '#B7FF00' },
  ...
  { id: 12, title: 'Multi-Face & Face Switch', category: 'camera', desc: 'Tap-to-switch active subject focus for couples and group shoots.', icon: Focus, status: 'Production v1.0', color: '#FF8A00' },

  // Discovery & 3D
  { id: 13, title: 'AI Pose Recommendations', category: 'context', desc: 'Curates ideal poses tailored to your current environment.', icon: Sparkles, status: 'Production v1.0', color: '#B7FF00' },
  { id: 14, title: 'Location-Aware Framing', category: 'context', desc: 'Tailors compositions for Beach, Mountain, Cafe, City, or Nature.', icon: Compass, status: 'Production v1.0', color: '#FF8A00' },
  { id: 15, title: 'Outfit-Aware Posing', category: 'context', desc: 'Adapts angles for Streetwear, Casual, Formal, or Traditional attire.', icon: Layers, status: 'Production v1.0', color: '#00D9FF' },
  { id: 16, title: '3D Pose Rotator', category: 'context', desc: 'Inspect pose angles from 360° before stepping in front of the lens.', icon: Box, status: 'Production v1.0', color: '#B7FF00' },
  { id: 17, title: 'Custom Template Creator', category: 'context', desc: 'Create and save your own pose templates directly from camera snaps.', icon: Sparkles, status: 'Production v1.0', color: '#00D9FF' },
  { id: 18, title: 'Context-Aware Filter Chain', category: 'context', desc: 'Harmonizes scene, lighting, and wardrobe into a single match rank.', icon: Sliders, status: 'Production v1.0', color: '#FF8A00' },

  // Personalization ML & Motivation
  { id: 19, title: 'Personalized ML Engine', category: 'ml', desc: 'Candidate generator prioritizing your unique aesthetic preferences.', icon: Brain, status: 'Production v1.0', color: '#B7FF00' },
  { id: 20, title: 'User Behavior Learning', category: 'ml', desc: 'Updates style weights via Exponential Moving Average (EMA).', icon: TrendingUp, status: 'Production v1.0', color: '#00D9FF' },
  { id: 21, title: '650+ Smart Nudges', category: 'ml', desc: 'Contextual notification scenarios for golden hour, weather, and roasts.', icon: Sparkles, status: 'Production v1.0', color: '#FF8A00' },
  { id: 22, title: 'Photographer Journey', category: 'ml', desc: '5-step interactive onboarding checklist tracking your posing mastery.', icon: CheckCircle2, status: 'Production v1.0', color: '#B7FF00' },
  { id: 23, title: 'Short-Term Session Memory', category: 'ml', desc: 'In-memory fast cache avoiding repeated poses in the same shoot.', icon: Layers, status: 'Production v1.0', color: '#00D9FF' },
  { id: 24, title: 'Long-Term Preference Vectors', category: 'ml', desc: 'Persistent MMKV vector that deepens your style profile over time.', icon: Brain, status: 'Production v1.0', color: '#B7FF00' },
  { id: 25, title: 'Recommendation Diversity (80/20)', category: 'ml', desc: '80% familiar favorites blended with 20% creative discovery poses.', icon: Sparkles, status: 'Production v1.0', color: '#FF8A00' },
  ...
  // Privacy & Offline
  { id: 27, title: 'Offline Pose Pack Manager', category: 'privacy', desc: 'Download curated categories with storage analyzer for offline travel.', icon: WifiOff, status: 'Production v1.0', color: '#B7FF00' },
  { id: 28, title: 'Fair-Use Capture Control', category: 'privacy', desc: '10 captures per 6-hour rolling window with optional rewarded ad unlocks.', icon: Lock, status: 'Production v1.0', color: '#FF8A00' },
